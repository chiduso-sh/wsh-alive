...
export default function LifestylePage() {
  const posts = getAllPosts("lifestyle");

  return (
    <div className="max-w-6xl mx-auto px-6 py-12">
      <div className="mb-10">
        <p className="text-xs tracking-widest uppercase text-earth font-medium mb-3">Lifestyle</p>
        <h1 className="font-serif text-4xl text-bark font-normal">Lifestyle articles</h1>
